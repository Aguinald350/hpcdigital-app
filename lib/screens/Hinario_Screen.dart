...
import 'package:flutter/material.dart';
import 'package:hpcdigital/screens/reading/personalizar_hinario_screen.dart';
import 'SecaoScreen.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip: 'Personalizar leitura',
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => const PersonalizarHinarioScreen(),
                ),
              );
            },
          )
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              ...
              trailing:
              Icon(Icons.arrow_forward_ios, color: cs.primary),
            ),
          );
        },
      ),
